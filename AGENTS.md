...
- **Acceptance & Recovery:** Plan execution requires current reviewer PASS and a single projection owner. Overbroad phases split once with inherited counters and integrated acceptance; exhausted atomic scopes return terminal FAIL. Ledger stages include structural recovery and aggregate acceptance. Spec: `docs/specs/agent-fabric.md`.
